...
export class ElementSelectors {
   ...
   */
  static byCustom(predicate: (element: any) => boolean): ElementSelector {
...
export class ProcessInstanceSelectors {
   ...
   */
  static byCustom(predicate: (instance: any) => boolean): ProcessInstanceSelector {
    return { type: 'custom', value: predicate };
  }
}
...
export class UserTaskSelectors {
   ...
   */
  static byCustom(predicate: (task: any) => boolean): UserTaskSelector {
    return { type: 'custom', value: predicate };
  }
}
...
export class DecisionSelectors {
   ...
   */
  static byCustom(predicate: (decision: any) => boolean): DecisionSelector {
    return { type: 'custom', value: predicate };
  }
   ...
   */
  static byResponse(response: any): DecisionSelector {
    return { type: 'key', value: response.decisionInstanceKey || response.key };
  }
}

// Re-export for convenience
export { ElementSelector, ProcessInstanceSelector, UserTaskSelector, DecisionSelector };

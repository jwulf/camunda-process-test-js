...
export class CamundaAssert {
   ...
   */
  static assertThat(processInstance: ProcessInstanceEvent): ProcessInstanceAssert {
   ...
   */
  static assertThatResult(processResult: ProcessInstanceResult): ProcessInstanceAssert {
    return new ProcessInstanceAssert(
      CamundaAssert.getContext(),
   ...
   */
  static assertThatProcess(selector: ProcessInstanceSelector): ProcessInstanceAssert {
    return new ProcessInstanceAssert(
      CamundaAssert.getContext(),
      selector,
      CamundaAssert.elementSelector,
   ...
   */
  static assertThatDecision(selector: DecisionSelector): DecisionInstanceAssert {
